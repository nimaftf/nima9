...
echo -e "               \e[01;34m                    @MemberPlus_TM                 \e[00;37;40m"
echo ""
cat << EOF
...
echo ""
echo -e "\033[38;5;208m @TgGuard    :)      @TgGuard \033[0;00m"
echo -e "\033[38;5;208m @sajjad_021    :)      @TgGuard \033[0;00m"
echo -e "\033[38;5;208m @TgGuard    :)      @TgGuard \033[0;00m"
echo -e "\033[38;5;208m @sajjad_021    :)      @TgGuard \033[0;00m"
echo -e "\033[38;5;208m @TgGuard    :)      @TgGuard \033[0;00m"
...
EOF
echo -e "                \e[100m                Steady script           \e[00;37;40m"
echo -e "               \e[01;34m                    @sajjad_021                 \e[00;37;40m"
echo ""
cat << EOF
 $bld$f1▄ ▀▄   ▄▀ ▄   $f2 ▄▄▄████▄▄▄    $f3  ▄██▄     $f4▄ ▀▄   ▄▀ ▄   $f5 ▄▄▄████▄▄▄    $f6  ▄██▄  $rst
 $bld$f1█▄█▀███▀█▄█   $f2███▀▀██▀▀███   $f3▄█▀██▀█▄   $f4█▄█▀███▀█▄█   $f5███▀▀██▀▀███   $f6▄█▀██▀█▄$rst
...
echo ""
echo -e "\033[38;5;208m @sajjad_021    :)      @MemberPlus_TM \033[0;00m"
echo -e "\033[38;5;208m @sajjad_021    :)      @MemberPlus_TM \033[0;00m"
echo -e "\033[38;5;208m @sajjad_021    :)      @MemberPlus_TM \033[0;00m"
echo -e "\033[38;5;208m @sajjad_021    :)      @MemberPlus_TM \033[0;00m"
echo -e "\033[38;5;208m @sajjad_021    :)      @MemberPlus_TM \033[0;00m"
...
while getopts ":tsTSih" opt; do
  case $opt in
	...
	echo -e "\e[1m"
	echo -e ""
	echo "steady.sh bash script v3 TgGuard" >&2
	echo ""
	echo -e "\e[0m"
